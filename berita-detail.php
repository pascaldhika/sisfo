    ...
    <main class="pt-28 pb-16 px-4 max-w-7xl mx-auto">
        ...
        <section class="max-w-4xl mx-auto mt-10 px-4">
            ...
            ?>
                ...
                <img src="admin/berita/uploads/<?= $row['foto'] ?>" alt="<?= $row['judul']; ?>" class="w-full h-72 object-cover mt-4 mb-6">
                ...
                <a href="berita.php" class="mt-5 sm:mt-6 px-5 py-2 sm:px-6 sm:py-3 bg-yellow-400 text-blue-900 font-semibold hover:bg-yellow-300 transition">
