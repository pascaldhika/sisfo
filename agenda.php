...
$result = mysqli_query($connection, "SELECT * FROM agenda ORDER BY id DESC");
?>
            ...
            ?>
                <div class="flex flex-col group overflow-hidden">
                    <div class="relative overflow-hidden">
                        <img src="admin/agenda/uploads/<?= $data['foto'] ?>" alt="<?= $data['judul']; ?>"
                    ...
                    <div class="mt-4 flex flex-col justify-between flex-1">
                        ...
                        <a href="agenda-detail.php?id=<?= $data['id']; ?>" 
